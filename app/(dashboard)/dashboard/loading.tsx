export default function DashboardLoading() {
  return (
    <div className="space-y-6">
      <div className="rounded-[0.85rem] border border-[#eadde5] bg-white p-6 shadow-[0_12px_32px_-26px_rgba(91,58,85,.32)] md:p-8">
      ...
      <div className="grid gap-5 sm:grid-cols-2 xl:grid-cols-3">
        {Array.from({ length: 6 }).map((_, index) => (
          <div
            key={index}
            className="rounded-[0.85rem] border border-[#eadde5] bg-white p-5 shadow-[0_12px_32px_-26px_rgba(91,58,85,.32)]"
          >
