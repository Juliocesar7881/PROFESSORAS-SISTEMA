  ...
  return (
    <main className="mesh-bg min-h-screen px-4 py-10 text-[#17213f] md:px-6">
      <section className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-4xl items-center">
        <div className="grid w-full gap-6 rounded-[0.95rem] border border-[#e8e3f0] bg-white p-6 shadow-[0_30px_90px_-52px_rgba(91,58,85,0.5)] md:grid-cols-[.9fr_1.1fr] md:p-8">
          <div className="flex flex-col justify-center">
            ...
            <h1 className="font-heading mt-4 text-4xl font-extrabold leading-tight text-[#17213f]">Sem conexão no momento</h1>
            <p className="mt-4 text-sm font-bold leading-relaxed text-[#6d6c82]">
            ...
            <Link href="/dashboard" className="mt-6 inline-flex h-12 w-fit items-center rounded-md bg-[linear-gradient(135deg,#4f3ca6,#b9a9f2)] px-5 text-sm font-bold text-white">
              Voltar ao painel
            </Link>
          </div>
