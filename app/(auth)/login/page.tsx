      ...
      <section className="relative z-10 w-full max-w-[900px] overflow-hidden rounded-[2rem] border border-white/10 bg-[#111827]/85 p-6 shadow-[0_40px_90px_-50px_rgba(0,0,0,0.8)] backdrop-blur md:p-8">
        <div className="grid gap-6 md:grid-cols-[1.2fr_0.8fr] md:items-center">
          <div className="space-y-5">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-3 py-1 text-xs font-bold uppercase tracking-[0.12em] text-white/90">
              <Sparkles className="size-3.5 text-[#FB7185]" />
              Planejei sistema
            </div>

            <div>
              <h1 className="font-heading text-4xl text-white sm:text-5xl">Entrar no sistema</h1>
              <p className="mt-3 max-w-xl text-sm leading-relaxed text-slate-300">
                Planejamento semanal, observacoes, chamada digital e relatorios da turma em um fluxo unico.
              </p>
            </div>
          ...
          <div className="rounded-2xl border border-white/15 bg-white/95 p-5 shadow-[0_24px_50px_-38px_rgba(15,23,42,0.85)]">
            <p className="mb-3 text-xs font-bold uppercase tracking-[0.12em] text-slate-500">Autenticacao</p>
            <p className="mb-4 text-sm text-slate-700">Acesso unico por conta Google.</p>

            <Button
              size="lg"
              onClick={handleGoogleSignIn}
              disabled={loading || status === "loading"}
              className="h-12 w-full rounded-xl bg-[#F43F5E] text-white transition hover:bg-[#E11D48]"
            >
            ...
            <p className="mt-4 text-xs text-slate-600">
              Ao continuar voce concorda com os <Link href="/termos" className="font-semibold underline">Termos</Link> e a <Link href="/privacidade" className="font-semibold underline">Politica de Privacidade</Link>.
            </p>
          </div>
        </div>
      </section>
